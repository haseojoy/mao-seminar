...
rows = [
    ...
    # ② 光熱費・通信費
    ("cat", "② 光熱費・通信費"),
    ("item",  "電気代（Japan電力）", "エポスカード", 10987, None, "3月利用分・4月引落 ¥10,987"),
    ("item",  "水道代（東京都水道局）", "エポスカード", 4532, None, "3月利用分・4月引落 ¥4,532"),
    ("item",  "ガス代（東京ガス）", "エポスカード", 5646, None, "2月利用分・4月引落 ¥5,646"),
    ("item",  "携帯（KDDI）", "エポスカード", 6773, None, "2月分KDDIご利用料金 ¥6,773"),
    ("item",  "携帯（UQ mobile）", "エポスカード", 4599, None, "3月分UQ mobileご利用料金 ¥4,599"),
    ("space",),
    ...
    ("item",  "Claude.ai サブスク", "エポスカード", 3284, 39408, "3/8 ¥3,284 引落確認済"),
    ("item",  "AWS（クラウド利用料）", "エポスカード", 174, 2088, "3/2 ¥174 引落確認済（業務費として計上可）"),
    ...
    ("cut",   "服・ファッション（ZARA 池袋店など）", "エポスカード", None, None, "3月 ZARA ¥8,600確認済・削減優先"),
    ("cut",   "趣味・ゲーム・娯楽", "カード / 現金", None, None, "カード明細で集計・削減優先"),
    ("space",),

    # ⑩ 日用品・小さな浪費
    ("cat", "⑩ 日用品・小さな浪費（変動費）"),
    ("item",  "Baluko コインランドリー（株式会社ルーブ）", "エポスカード", 2750, None, "3月実績 ¥2,750（¥200〜¥980×複数回）"),
...
actions = [
    ...
    ("通信費2回線→1回線集約", 11372, 6000, 5372, "検討中", "KDDI¥6,773+UQ¥4,599=¥11,372 → 1回線に絞れないか"),
    ("Claude.ai（業務費用化）", 3284, None, None, "検討中", "業務利用なら経費計上可・テックビズ税理士に確認"),
    ...
    ("美容・服の予算化（ZARA等）", None, None, None, "要集計", "3月ZARA¥8,600確認済・月予算を設定"),
]
